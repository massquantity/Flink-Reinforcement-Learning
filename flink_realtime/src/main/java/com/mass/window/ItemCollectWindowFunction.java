...
public class ItemCollectWindowFunction extends
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        ValueStateDescriptor<LinkedList<Integer>> itemStateDesc = new ValueStateDescriptor<>(
                "itemState", TypeInformation.of(new TypeHint<LinkedList<Integer>>() {}),
                new LinkedList<>());
    ...
    public void process(Tuple key, Context ctx, Iterable<RecordEntity> elements,
                        Collector<UserConsumed> out) throws IOException {
