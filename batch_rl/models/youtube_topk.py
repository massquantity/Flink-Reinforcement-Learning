...
class Reinforce(nn.Module):
    ...
    def _compute_loss(self, data):
        if self.adaptive_softmax:
            ...
            all_logp = (
                self.softmax_loss.log_prob(action)
                if self.debug
                else None
            )
            ...
            state, all_logp = self.policy.get_log_probs(data)
        ...
        return policy_loss, beta_loss, all_logp, importance_weight, lambda_k
